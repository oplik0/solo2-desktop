...
<section>
    ...
    <ContentDialog {open} class="register-dialog">
        ...
        <fieldset>
            ...
            <TextBox bind:value={label} type="text" placeholder="label"></TextBox>
        </fieldset>
        <fieldset>
            <TextBlock>Issuer (optional)</TextBlock>
            <TextBox bind:value={issuer} type="text"></TextBox>
        </fieldset>
        <fieldset>
            <TextBlock>TOTP Secret</TextBlock>
            <TextBox bind:value={secret} type="text"></TextBox>
        </fieldset>
        <Expander>
            ...
            <svelte:fragment slot="content">
                <fieldset>
                    ...
                    <div class="radio">
                        ...
                        <RadioButton bind:group={algorithm} value="sha256">SHA256</RadioButton>
                    </div>
                </fieldset>
                <fieldset>
                    <TextBlock>TOTP Period</TextBlock>
                    <TextBox bind:value={period} type="number" placeholder=30></TextBox>
                </fieldset>
                <fieldset>
                    <TextBlock>Digits</TextBlock>
                    <TextBox bind:value={digits} type="number" placeholder=6></TextBox>
                </fieldset>
            </svelte:fragment>
        </Expander>
        <svelte:fragment slot="footer">
            <Button slot="footer" variant="accent" disabled={!label?.length || !secret?.length} on:click={registerOath}>Register</Button>
